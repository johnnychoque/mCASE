...
$cfgFile = "configs/mCASE-commag.cfg";
$totSimulation_ = 100;
$totStrategies_ = 4;
$PmaxGSM = 1;
...
@handover_= (0.00, 0.50, 0.50, 0.50);
@load_    = (0.00, 0.00, 0.00, 0.50);
@price_   = (1.00, 0.50, 0.50, 0.00);
@quality_ = (0.00, 0.00, 0.00, 0.00);
@prefOP_  = (0.00, 0.00, 0.00, 0.00);
...
{
    my($numStr_,$priceRate_,$numSim_) = @_;
    my($command,$path,$numStr,$priceRate,$numSim);
...
#    printf("%s\n",$command);
	...
	$priceRate = sprintf("%03d",$priceRate_);
	$numSim = sprintf("%03d",$numSim_);
	
	$command = "mv ".$path."serviceStats.out ".$path.$numStr."_serviceStats_".$priceRate."_".$numSim.".out";
	system($command);
#	$command = "mv ".$path."userStats.out ".$path.$numStr."_userStats_".$priceRate."_".$numSim.".out";
#	system($command);
#	$command = "mv ".$path."linkQualityStats.out ".$path.$numStr."_linkQualityStats_".$priceRate."_".$numSim.".out";
#	system($command);	
	$command = "mv ".$path."hoPerServStats.out ".$path.$numStr."_hoPerServStats_".$priceRate."_".$numSim.".out";
	system($command);
#	$command = "mv ".$path."hoPerUserStats.out ".$path.$numStr."_hoPerUserStats_".$priceRate."_".$numSim.".out";
#	system($command);
	$command = "mv ".$path."loadStats.out ".$path.$numStr."_loadStats_".$priceRate."_".$numSim.".out";
	system($command);	
	$command = "mv ".$path."paramsList.out ".$path.$numStr."_paramsList_".$priceRate."_".$numSim.".out";
	system($command);
	$command = "mv ".$path."priceList.out ".$path.$numStr."_priceList_".$priceRate."_".$numSim.".out";
	system($command);
	$command = "mv ".$path."pricePerServStats.out ".$path.$numStr."_pricePerServStats_".$priceRate."_".$numSim.".out";
	system($command);
#	$command = "mv ".$path."pricePerUserStats.out ".$path.$numStr."_pricePerUserStats_".$priceRate."_".$numSim.".out";
#	system($command);
}
